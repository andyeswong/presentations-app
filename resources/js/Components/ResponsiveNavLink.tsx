    ...
    return (
        <Link
            ...
            className={`w-full flex items-start ps-3 pe-4 py-2 border-l-4 ${
                active
                    ? 'border-amber-500 dark:border-amber-400 text-amber-700 dark:text-amber-300 bg-amber-50 dark:bg-amber-900/50 focus:text-amber-800 dark:focus:text-amber-200 focus:bg-amber-100 dark:focus:bg-amber-900 focus:border-amber-700 dark:focus:border-amber-300'
